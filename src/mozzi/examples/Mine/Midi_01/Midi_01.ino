/*  
  Title: Arduino based audiosynthesizer with MIDI interface
  Autor: Cristhian Novais
...
Oscil <8192, AUDIO_RATE> aOscil(TRIANGLE_WARM8192_DATA);
Oscil <8192, AUDIO_RATE> aOsci2(TRIANGLE_WARM8192_DATA);
Oscil <8192, AUDIO_RATE> aOsci3(TRIANGLE_WARM8192_DATA);
Oscil <8192, AUDIO_RATE> aOsci4(TRIANGLE_WARM8192_DATA);
*/

//MIX SAW AND COSINE WAVE
/*
#include <tables/cos8192_int8.h> 
#include <tables/saw8192_int8.h> 
Oscil <8192, AUDIO_RATE> aOscil(COS8192_DATA);
Oscil <8192, AUDIO_RATE> aOsci2(SAW8192_DATA);
Oscil <8192, AUDIO_RATE> aOsci3(COS8192_DATA);
Oscil <8192, AUDIO_RATE> aOsci4(SAW8192_DATA);
*/
